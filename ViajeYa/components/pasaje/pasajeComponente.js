import globoComponente from "../globoDialogo/globoComponente.js";
...
export default  function creacionPasaje(datos){
      ...
      <div class="resultado-pasaje" data-id-viaje="${datos.idViaje}">
         ...
         <div class="tipo-vehiculo border-superior">
          ...
          <div class="recorrido border-superior">
              <h4 class="recorrido_label">Recorrido</h4>
          </div>
    ...
    const btnRecorrido = pasajeComponente.querySelector(".recorrido_label");


    btnRecorrido.addEventListener("click",()=> obtenerElRecorrido(datos,btnRecorrido))
...
function obtenerElRecorrido(datos,elemento){
        
    let body = document.getElementsByTagName("body")[0];
    
    body.innerHTML += globoComponente(datos);
